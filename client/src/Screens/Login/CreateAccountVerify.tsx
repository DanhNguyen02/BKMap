...
export const CreateAccountVerify = ({navigation}) => {
    const navigateOnVerify = () => {
        navigation.navigate('CreateAccountFinish');
    }
  ...
  return (
    ...
    paddingTop: 50}} onPress={Keyboard.dismiss}>
      ...
      <Text style = {{color: 'black', fontSize: 14, fontStyle: 'italic'}}>Please enter the code that has been sent to your email in order to finish creating account</Text>
      </View>
