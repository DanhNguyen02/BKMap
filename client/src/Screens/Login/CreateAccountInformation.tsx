...
export const CreateAccountInformation = ({navigation}) => {
  ...
  return (
    ...
    paddingTop: 30}}>
      ...
      <View style={{padding: 10}}><InforField title={'First name'} onInput={setfirstname}/></View>
      <View style={{padding: 10}}><InforField title={'Last name'} onInput={setlastname}/></View>
      <View style={{padding: 10}}><InforField title={'Email'} onInput={setemail}/></View>
      <View style={{padding: 10}}><InforField title={'Phone Number'} onInput={setphone}/></View>
      <View style={{padding: 10}}><InforField title={'Address'} onInput={setaddress}/></View>

      <View style={{padding: 10}}><InforField title={'Username'} onInput={setusername}/></View>
      <View style={{padding: 10}}><SecureField title={'Password'} onInput={setpassword}/></View>
      <View><Text style = {{color: 'red', fontSize: 14, opacity: exist ? 1 : 0}}>Username already exists. Please use another</Text></View>

      <View style={{paddingTop: 15}}><Text style = {{color: 'black', fontSize: 14,}}>These are security questions</Text></View>
